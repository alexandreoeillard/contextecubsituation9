#=====================================================
#
#NAME: Exercice DHCP2.ps1
#AUTHOR: Oeillard Alexandre
#DATE:27/03/2024
#
#VERSION 1.0
#COMMENTS: Demande info pour créer nouvelle étendue + nom de domaine et @ip serv de domaine
#=====================================================
...
$adresseDomaine = Read-Host "Entrez l'adresse du serveur de domaine"
...
Write-Host "Nom de domaine : $nomDomaine"-ForegroundColor Cyan
Write-Host "Adresse du serveur de domaine : $adresseDomaine"-ForegroundColor Cyan
...
if ($confirmation -eq "Oui") {
    ...
    # Ajouter le nom de domaine et l'adresse du serveur de domaine
    Set-DhcpServerv4OptionValue -OptionId 15 -Value $nomDomaine -State Active
    Set-DhcpServerv4OptionValue -OptionId 6 -Value $adresseDomaine -State Active
    ...
    Write-Host "Nom de domaine : $nomDomaine"-ForegroundColor Green
    Write-Host "Adresse du serveur de domaine : $adresseDomaine"-ForegroundColor Green
}
else {
